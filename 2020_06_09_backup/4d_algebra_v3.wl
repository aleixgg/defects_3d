...
Commutator[(-I \[ScriptCapitalM][1, 2] + \[ScriptCapitalR]), \[ScriptCapitalQ]p[1]] // Expand
Commutator[(-I \[ScriptCapitalM][1, 2] + \[ScriptCapitalR]), \[ScriptCapitalQ]m[1]] // Expand
...
bosEq = (\[Eta]^2-1)f''[\[Eta]]+(\[Eta]+2r Sqrt[\[Eta]^2-1])f'[\[Eta]];
...
DSolve[-4 (-1+r) w2 Derivative[1][g][w2]+4 w2^2 (g^\[Prime]\[Prime])[w2] == 0, g[w2], w2]
