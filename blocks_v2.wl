...
\[ScriptCapitalC]SusyVal = +\[CapitalDelta] (\[CapitalDelta]-d + 2);
expr = (\[ScriptCapitalC]2d[1, 2][twoPtFunDef] - \[ScriptCapitalC]SusyVal twoPtFunDef) / twoPtFunDef // ExpandAll;
expr = expr /. restore\[Xi] // Together // Numerator // Collect[#, f_[\[Xi]], Factor] &
...
expr = (
d[1][0] x[1][0]-I d[1][1] x[1][0]+I d[1][0] x[1][1]+d[1][1] x[1][1]
-(d[2][2] x[1][0]^2)/x[1][2]-(d[2][2] x[1][1]^2)/x[1][2]+d[1][2] x[1][2]-d[2][2] x[1][2]
-d[1][0] x[2][0]+I d[1][1] x[2][0]+(2 d[2][2] x[1][0] x[2][0])/x[1][2]-(d[2][2] x[2][0]^2)/x[1][2]
-I d[1][0] x[2][1]-d[1][1] x[2][1]+(2 d[2][2] x[1][1] x[2][1])/x[1][2]-(d[2][2] x[2][1]^2)/x[1][2]
-d[1][2] x[2][2]+d[2][2] x[2][2]-(d[2][0] x[1][0] x[2][2])/x[1][2]-(I d[2][1] x[1][0] x[2][2])/x[1][2]
+(I d[2][0] x[1][1] x[2][2])/x[1][2]-(d[2][1] x[1][1] x[2][2])/x[1][2]+(d[2][0] x[2][0] x[2][2])/x[1][2]
+(I d[2][1] x[2][0] x[2][2])/x[1][2]-(I d[2][0] x[2][1] x[2][2])/x[1][2]+(d[2][1] x[2][1] x[2][2])/x[1][2]
...
diffEq = (
	+ f[\[Xi]] (-d \[CapitalDelta]+\[CapitalDelta]^2+d \[CapitalDelta][1]-\[CapitalDelta][1]^2+d \[CapitalDelta][2]-2 \[CapitalDelta][1] \[CapitalDelta][2]-4 \[Xi] \[CapitalDelta][1] \[CapitalDelta][2]-\[CapitalDelta][2]^2)
	- 2 \[Xi] (2-d+2 \[Xi]+2 \[CapitalDelta][1]+2 \[Xi] \[CapitalDelta][1]+2 \[CapitalDelta][2]+2 \[Xi] \[CapitalDelta][2]) Derivative[1][f][\[Xi]]-4 \[Xi]^2 (1+\[Xi]) (f^\[Prime]\[Prime])[\[Xi]]
	+(2 \[CapitalDelta]p (1+2 \[Xi]) f[\[Xi]]+4 \[Xi] (1+\[Xi]) Derivative[1][f][\[Xi]])
) /. {d -> 3, \[CapitalDelta][_] -> \[CapitalDelta]p}
...
Table[
	1-12 \[CapitalDelta]+4 \[CapitalDelta]^2+16 \[CapitalDelta]p-8 a \[CapitalDelta]p // Factor
, {a, -4, 4, 1/4}]


9+12 a+4 a^2-12 \[CapitalDelta]+4 \[CapitalDelta]^2 /. a -> -3 // Factor


lhs = (
(*	\[Xi]^(1/2 (-3+\[CapitalDelta]-2 \[CapitalDelta]p)) Hypergeometric2F1[-(3/2)+\[CapitalDelta]/2,3/2+\[CapitalDelta]/2,-(1/2)+\[CapitalDelta],-\[Xi]] *)
	\[Xi]^(1/2 (\[CapitalDelta]-2 \[CapitalDelta]p)) Hypergeometric2F1[\[CapitalDelta]/2,\[CapitalDelta]/2,-(1/2)+\[CapitalDelta],-\[Xi]]
);
block[\[CapitalDelta]_] := \[Xi]^(1/2 (\[CapitalDelta]-2 \[CapitalDelta]p)) Hypergeometric2F1[\[CapitalDelta]/2,\[CapitalDelta]/2,-(1/2)+\[CapitalDelta],-\[Xi]];
rhs = (
	+ a[0] block[\[CapitalDelta]]
	+ a[1] block[\[CapitalDelta]+1/2]
	+ a[2] block[\[CapitalDelta]+1]
	+ a[3] block[\[CapitalDelta]+3/2]
	+ a[4] block[\[CapitalDelta]+2]
);
diff = Normal@Series[lhs - rhs, {\[Xi], 0, 5}] // ExpandAll;
powers = DeleteDuplicates@Cases[diff, \[Xi]^_, Infinity];
Coefficient[diff, #] & /@ powers
